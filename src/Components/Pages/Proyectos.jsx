  ...
  return (
    <section id="proyectos" className=" py-12">
      <div className="container mx-auto px-4 text-center ">
        ...
        <div className="max-w-xl w-1/2 bg-white m-4 p-6 rounded-lg shadow-md relative">
            ...
            <a href="#" className="absolute bottom-0 right-0 p-2 bg-gray-800 rounded-lg">
          ...
          <div className="max-w-xl w-1/2 bg-white m-4 p-6 rounded-lg shadow-md relative">
            <h3 className="text-xl font-bold text-black mb-2">Proyecto 4</h3>
            <p className="text-gray-700 mb-4">Descripción breve del proyecto.</p>
            <a href="https://example.com" className="text-blue-500 hover:underline">Ver más</a>
            <a href="#" className="absolute bottom-0 right-0 p-2 bg-gray-800 rounded-lg">
              <span className="text-white"><FaGithub /></span>
